...
class FM_block1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Fm Block1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fm Block1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FM_block1")
...
def main(top_block_cls=FM_block1, options=None):
