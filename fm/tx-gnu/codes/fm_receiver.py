...
class fm1_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "frm_receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("frm_receiver")
        ...
        # Blocks
        ##################################################
        self._tune_range = Range(88.1, 107.9, 0.2, 102, 200)
        ...
        labels = ['Low Passed Re', 'Low Passed Im', 'Signal 3', 'Signal 4', 'Signal 5',
    ...
    def closeEvent(self, event):
        self.settings = Qt.QSettings("GNU Radio", "fm1_receiver")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(5, self.samp_rate, 100e3, 50e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=fm1_receiver, options=None):
