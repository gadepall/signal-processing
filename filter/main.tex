...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\columnwidth]{./filter/figs/xnyn}
\end{center}
%\captionof{figure}{}
	\caption{}
\label{fig:xnyn}	
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./filter/figs/dtft}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./filter/figs/hn}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./filter/figs/hndef}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./filter/figs/ynconv}
...
Compute
\begin{equation}
X(k) \triangleq \sum _{n=0}^{N-1}x(n) e^{-\j2\pi kn/N}, \quad k = 0,1,\dots, N-1
\end{equation}
and $H(k)$ using $h(n)$.
\item Compute 
\begin{equation}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{./filter/figs/yndft}
