...
\solution Using \eqref{eq:pingala/X-z},
\begin{align}
...
\begin{align}
    y(n) &= \frac{\brak{\alpha^{n + 1} - \beta^{n + 1}} + \brak{2\alpha^n + 2\beta^n}}{\alpha - \beta} \\
         &= \frac{\brak{\alpha^{n + 2} - \beta^{n + 2}} + \brak{\alpha^{n} + \beta^{n}}}{\alpha - \beta} \label{eq:pingala/y-b} \\
...
Comparing \eqref{eq:pingala/y-b} with the definition of $b_n$, we see that $y(n) = b_{n + 1}$.
